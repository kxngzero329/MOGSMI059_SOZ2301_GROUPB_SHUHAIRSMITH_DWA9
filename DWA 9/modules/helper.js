...
export const html = {
  ...
  /**
   * id used to check if it is an element or is null or  undefined
   * @param {Element | null | undefined} element is the alleged html element to be used
   * @returns {*}
   */
export const checkIfNullOrUndefined = (element) =>{
  if (element === null || undefined) {
     console.log(`the elementHtml you entered is ${element}`)
    throw new Error(element , `is equal to null or undefined since the ${element} is not a HtmlElement`)
  }
  return  element
 }
